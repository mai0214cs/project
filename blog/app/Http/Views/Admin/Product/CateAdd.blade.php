            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="id_category">
                                ...
                                <option {{old('id_category')==$item['id']?'selected="selected"':''}} value="{{$item['id']}}">{{$item['name']}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>            
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="imageavatar"><img style="width:100px;" src="/image.png" /></div>
                            <input type="hidden" class="form-control" name="avatar" value="{{old('avatar')}}" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <label class="radio-inline">
                                <input name="status" value="Yes" {{old('status')=='Yes'?'checked="checked"':''}} type="radio">{{trans('admin.show')}}
                            </label>
                            <label class="radio-inline">
